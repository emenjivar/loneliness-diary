...
class MainActivity : ComponentActivity() {
    @Inject
    lateinit var imageLoader: ImageLoaderProvider

    @Inject
    lateinit var exoplayer: ExoplayerProvider
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CompositionLocalProvider(
                LocalCoilImageLoaderProvider provides imageLoader,
                LocalExoplayerProvider provides exoplayer
            ) {
